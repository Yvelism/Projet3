...
def reset():
    ...
    global perso_x, perso_y, jump, monte, descente, scroll, continuous_scroll, floor, last_floor, \
        last_scroll, vie, ennemi_liste, ennemi_vitesse_mouv, background, points, \
        star_liste, last_perso_x, arbre_liste, buisson_liste
    perso_x = 128
    perso_y = 182
    jump = False
    monte = False
...
class App:
    ...
    def update():
        ...
        global scroll, last_scroll, plateforme_liste, floor, playing, continuous_scroll, taille_ennemi_y, vie, \
            niveau, compteur, ennemi_vitesse_mouv, star_liste, arbre_liste, buisson_liste, star1, \
