...
taille_star_x = 5
taille_star_y = 10
hauteur_0_star = 192 - taille_star_y
...
class Perso:
    def __init__(self,perso_x=128,perso_y=182,jump = False,compteuranimation1=True,compteuranimation2=True,avatar1=True,\
                avatar2=False,avatar3=False,touche=False,monte = False, descente = False,floor = 192,last_floor = 192):
...
class App:
    ...
    def draw(inutile=False): # from line 762
